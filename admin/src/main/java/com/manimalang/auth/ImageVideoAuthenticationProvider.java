...
public class ImageVideoAuthenticationProvider implements AuthenticationProvider {

	private static final Logger logger = Logger.getLogger(ImageVideoAuthenticationProvider.class);
